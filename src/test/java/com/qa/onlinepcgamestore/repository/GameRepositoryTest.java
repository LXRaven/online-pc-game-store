...
public class GameRepositoryTest {
	...
	public void given_GetAllGames_Should_Return_Game_List() {
		gameRepository.save(game1);
		gameRepository.save(game2);
		gameRepository.save(game3);
		
		List<Game> gameList = gameRepository.findAll();
		assertEquals(3, gameList.size(),"game list size should be 3");
		assertEquals("game1",gameList.get(0).getName());
	}
	...
	public void given_Non_Existing_Id_Should_Return_Optional_Empty() {
		gameRepository.save(game1);
		assertThat(gameRepository.findById(2)).isEmpty();
	}
}
